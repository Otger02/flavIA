...
export type Database = {
  public: {
    Tables: {
      ...
      scraped_public_sources: {
        Row: {
          id: string;
          source_url: string;
          source_type: "youtube" | "media_article" | "podcast_transcript" | "manual_text";
          title: string;
          author: string | null;
          published_at: string | null;
          raw_text: string;
      ...
      public_content_proposals: {
        Row: {
          id: string;
          source_id: string;
          proposal_type: "quickly_item" | "article" | "community_thread" | "signature_phrase";
          title: string;
          excerpt: string;
          full_content: string;
      ...
      flavia_phrase_candidates: {
        Row: {
          ...
          context: string | null;
          source_quote: string;
          status: "pending" | "added_to_prompt" | "rejected";
