...
export const LIBRARY_CONTENT_TYPES = ["article", "audio", "guide", "faq", "script", "video", "book_recommendation"] as const;

export const LIBRARY_DOCUMENT_TYPES = ["article", "audio", "guide", "faq", "script", "video", "book_recommendation"] as const;
