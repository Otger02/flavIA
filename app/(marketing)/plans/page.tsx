...
export const metadata: Metadata = {
  title: "Planes",
  description:
    "Empieza gratis o desbloquea conversaciones ilimitadas con Flavia Plus. Elige el plan que mejor se adapte a ti.",
  openGraph: {
    title: "Planes — Flavia",
    description:
      "Empieza gratis o desbloquea conversaciones ilimitadas con Flavia Plus. Elige el plan que mejor se adapte a ti.",
    ...
    <section className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <article className="flex flex-col rounded-[2rem] border border-stone-200/80 bg-white/80 p-7 shadow-[0_20px_60px_rgba(180,120,100,0.06)] backdrop-blur">
          ...
          <p className="mt-1 text-2xl font-semibold text-stone-400">$0</p>
        ...
        <article className="relative z-10 scale-[1.02] overflow-visible rounded-[2rem] border border-rose-400/20 bg-gradient-to-br from-stone-950 to-[#1a1210] p-7 text-stone-50 shadow-[0_24px_80px_rgba(120,40,40,0.18)]">
          <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-gradient-to-r from-rose-400 to-rose-500 px-4 py-1.5 text-xs font-medium text-white shadow-lg">Recomendado</span>
          ...
          <div className="relative">
            ...
            <div className="mt-3 flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 flex items-baseline gap-1.5">
                  <span className="font-[family-name:var(--font-display)] text-4xl font-semibold text-white">50.000</span>
            ...
            <p className="mt-5 text-xs font-medium uppercase tracking-wider text-rose-400/60">Todo lo de Gratis, mas:</p>
